    ...
    <SafeAreaView style={styles.screen}>
      <View style={styles.surface}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          {review.capturedFiles.length > 0 ? (
            <View style={styles.grid}>
              {review.capturedFiles.map((file, index) => (
                <View key={file.id} style={styles.gridCard}>
                  <Pressable onPress={() => review.setPreviewFile(file)}>
                    <Image source={{ uri: file.uri }} style={styles.gridPreview} contentFit="cover" />
                  </Pressable>
                  ...
                  <View style={styles.gridFooter}>
                    ...
                    <Pressable style={styles.removeButton} onPress={() => review.handleRemove(file.id)}>
      ...
      <Modal
        visible={review.previewFile !== null}
        transparent
        animationType="fade"
        onRequestClose={review.handleClosePreview}
      >
        <View style={styles.previewModal}>
          <Pressable style={styles.previewBackdrop} onPress={review.handleClosePreview} />

          <View style={styles.previewShell}>
            <Pressable style={styles.previewClose} onPress={review.handleClosePreview}>
              <MaterialIcons name="close" size={18} color={COLORS.white} />
            </Pressable>

            {review.previewFile ? (
              <Image
                source={{ uri: review.previewFile.uri }}

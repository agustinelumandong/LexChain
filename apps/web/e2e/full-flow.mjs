...
const LAWYER = { email: 'lawyer@lexchain.com', password: 'Lawyer123!' };
const PARTICIPANT = { email: 'lodexep679@kingcq.com', password: '@Sean08282005' };
const PDF_PATH = '/home/cshan28/Dev/Projects/School-Project/LexChain/docs/scanned-docx-for-testing/sample_scanned_deed_of_sale_app_test.pdf';

...
import type { DocumentParticipantPermission } from '../lib/participant-access';
import { documentParticipantPermissions, validateParticipantInvitation } from '../lib/participant-access';

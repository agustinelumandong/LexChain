      ...
      <div className="flex h-full w-full flex-col gap-6">
        <header className="flex flex-wrap items-start justify-between gap-4">
          <div className="space-y-1.5">
            ...
            <h1 className="text-[32px] font-black leading-[38px] text-[#0C2B49]">Issuer Invitations</h1>
            <p className="max-w-3xl text-sm font-semibold leading-5 text-[#64748b]">Manage Document Issuer invitations — create new invites and revoke existing ones.</p>
          </div>

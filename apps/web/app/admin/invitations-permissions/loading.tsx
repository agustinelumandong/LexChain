      ...
      <div className="flex h-full w-full flex-col gap-6">
        <header className="flex flex-wrap items-start justify-between gap-4">
          <div className="space-y-1.5">
            <p className="text-xs font-black uppercase tracking-[0.16em] text-[#0985E7]">LexChain Super Admin</p>
            <h1 className="text-[32px] font-black leading-[38px] text-[#0C2B49]">Invitations & Permissions</h1>
            <p className="max-w-3xl text-sm font-semibold leading-5 text-[#64748b]">Manage lawyer invitations — create new invites and revoke existing ones.</p>
          </div>
